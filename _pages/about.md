...
I’ve been pursuing my **PhD degree of Electrical Engineering at National Yang Ming Chiao Tung University** since **September 2026** 🎓. Under the supervision of professor Shuai, Hong-Han.
...
I'm the **first author** of publications at **SIGGRAPH 2026**, **ICCV 2025**, **AAAI 2025**, and **WACV 2024**,  
and also **co-author** of papers accepted at **ECCV 2026**, **ICIP 2025 (Oral)**, **EMNLP 2025 (Findings)** 📄✨.
...
<div style="display: flex; flex-wrap: wrap; align-items: flex-start; gap: 10px;">
  <img src="images/vecset_edit.png" alt="teaser" style="width: 100%; max-width: 800px; height: auto;">
  <div style="flex: 1; min-width: 200px;">
    <b style="display: inline-block; max-width: 100%; word-break: break-word;">
    VecSet-Edit: Unleashing Pre-trained LRM for Mesh Editing from Single Image
    </b><br>
    <i><u>Teng-Fang Hsiao</u>, Bo-Kai Ruan, Yu-Lun Liu, Hong-Han Shuai</i> <br>
    <i>Special Interest Group on Computer Graphics and Interactive Techniques Conference Papers (SIGGRAPH), 2026</i> <br>
    Editing 3D Mesh with image-only instruction, without 3D annotation 🖼️🔥🐶<br> 
    <a href="https://dl.acm.org/doi/full/10.1145/3799902.3811126">pdf</a> /
    <a href="https://github.com/BlueDyee/VecSet-Edit">GitHub</a> /
    <a href="https://github.com/BlueDyee/VecSet-Edit/">Project page</a>
  </div>
</div>
...
<div style="display: flex; flex-wrap: wrap; align-items: flex-start; gap: 10px;">
  ...
  <div style="flex: 1; min-width: 200px;">
    ...
    <i>Proceedings of the IEEE/CVF Winter Conference on Applications of Computer Vision (WACV), 2026 </i><br>
...
<div style="display: flex; flex-wrap: wrap; align-items: flex-start; gap: 10px;">
  <img src="images/R2F.png" alt="teaser" style="width: 100%; max-width: 800px; height: auto;">
  <div style="flex: 1; min-width: 200px;">
    <b style="display: inline-block; max-width: 100%; word-break: break-word;">
    RADIANCE: Relative Adaptive Denoising with IP-Adapter for Novel Concept Enhancement
    </b><br>
    <i>Zi-Xiang Ni, Bo-Lun Huang, <u>Teng-Fang Hsiao</u>, Bo-Kai Ruan, Hong-Han Shuai</i> <br>
    <i>European Conference on Computer Vision (ECCV), 2026</i> <br>
    Enhance image generation with rare concepts in a Training-Free manner 🐶😸🐛<br> 
    <a href="https://arxiv.org/abs/2607.05088">pdf</a> /
  </div>
</div>
...
<div style="display: flex; flex-wrap: wrap; align-items: flex-start; gap: 10px;">
  ...
  <div style="flex: 1; min-width: 200px;">
    ...
    <i>IEEE/CVF Winter Conference on Applications of Computer Vision (WACV), 2024</i> <br>
